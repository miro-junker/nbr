...
export const getPlanePosX = (gameState: TGameState, newPlaneRotationX: number, delta: number) => {
...
export const getPlanePosY = (gameState: TGameState, steering: TSteering, delta: number) => {
    // TBD
}